...
drop view view_click_stream_add_promo;
drop view view_click_stream_add_to_cart;
drop view view_click_stream_booking;
drop view view_click_stream_search;
...
LOAD DATA LOCAL INFILE 'C:/Users/user/Desktop/workspace/Datathon/data/order_items.csv'
INTO TABLE click_stream
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'C:/Users/user/Desktop/workspace/Datathon/data/nullfix_product.csv'
INTO TABLE click_stream
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\n'
